...
public class MemberController {
	...
	public String update(@ModelAttribute MemberDTO dto, @RequestParam String memId, Model model, HttpSession session) {
	...
	@RequestMapping(value = "/member/findPasswd", method = RequestMethod.GET)
